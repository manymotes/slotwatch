      ...
      {res && (
        <div style={{ marginTop: '20px', paddingTop: '20px', borderTop: '1px solid #1f1f1f' }}>
          ...
          {res.earliest ? (
            <>
              ...
              <p style={{ color: '#8a8a8a', fontSize: '0.9375rem', margin: '0 0 16px', lineHeight: 1.55 }}>
                Want something sooner? Slots open all day as people cancel. SlotWatch watches this center and emails you the moment an earlier one appears — free for 14 days, then $6.99/mo, cancel anytime.
              </p>
            </>
          ) : (
          ...
          <a href={`/start/?city=${encodeURIComponent(res.city)}`}
            ...
            Watch {res.center.replace('Tesla Service ', '')} — free for 14 days →
          </a>
        </div>
      )}
    </div>
